...
{
  {FUNC_GPIOHS0 + _USE_GPIOHS_LED_R, _USE_GPIOHS_LED_R, 14, GPIO_PV_LOW, GPIO_PV_HIGH},
  {FUNC_GPIOHS0 + _USE_GPIOHS_LED_G, _USE_GPIOHS_LED_G, 13, GPIO_PV_LOW, GPIO_PV_HIGH},
  {FUNC_GPIOHS0 + _USE_GPIOHS_LED_B, _USE_GPIOHS_LED_B, 12, GPIO_PV_LOW, GPIO_PV_HIGH},
};
